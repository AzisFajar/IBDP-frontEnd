...
import stories1 from '../assets/img/stories1.svg'
import stories2 from '../assets/img/stories2.svg'
import stories3 from '../assets/img/stories3.svg'
import stories4 from '../assets/img/stories4.svg'
import stories5 from '../assets/img/stories5.svg'
import stories6 from '../assets/img/stories6.svg'

import news1 from '../assets/img/maya.svg'
import news2 from '../assets/img/kepedulian.svg'
import news3 from '../assets/img/pamerdonor.svg'

const storiesData = [
    {
        id: 1,
        image: stories1,
        kategori: 'Cerita Para Pendonor',
        title: 'Cerita Para Pendonor Darah Perdana',
        imgUser: imgUser,
        nameUser: 'Dika Pangestu',
        date: "31 okt 2023",
        description: `Untuk Pertama kali tanggal 12 Juni 2022 melakukan donor darah Apheresis. Untuk alurnya sendiri yaitu, kita akan di ambil sampel darahnya untuk di tes dan di cocokkan ke pasien yang membutuhkan, waktunya mencapai 5-6 jam untuk selesai pengecekan. Kemarin saya di ambil sampel darahnya pukul 10.00 WIB dan waktu maghrib sekitar jam 18.10 WIB dihubungi oleh pihak rumahsakit dan dinyatakan lolos, lalu dijadwalkan jam 8 malam untuk proses pengambilan darah. Jam 8 kurang sedikit saya sampai di unit Transfusi Darah dan pertama kali saya di cek tensi. Tensi saya normal dan dinyatakan bisa di ambil. Selanjutnya disuruh menunggu dokter jaga untuk menghidupkan mesin pengambilan darahnya, dan pada pukul 20.22 WIB transfusi pengambilan darah dimulai. Proses pengambilan darahnya berlangsung lancar, sampai pukul 21.22 WIB`},    
  {
    id: 2,
    image: stories2,
    kategori: 'Cerita Unik',
    title: 'Pengalaman unik Sapto Nugroho, sudah donor darah 100 kali',
    imgUser: imgUser,
    nameUser: 'Sapto Nugroho',
    date: "14 Juni 2023",
    description: `“Kemarin saya ingin mendonorkan darah, tetapi ditolak karena Hb (Hemoglobin) saya tinggi. Kemudian hari ini juga tertunda, rupanya ada peringatan ini.
  ...
  },
  {
    id: 3,
    image: stories3,
    kategori: 'Cerita  heroik relawan donor darah',
    title: 'Kisah heroik Relawan Donor Darah di Masa Paceklik ',
    imgUser: imgUser,
    nameUser: 'Amar ',
    date: "31 0kt 2023",
    description: `Pengalaman menarik yang paling saya ingat itu ketika ada orang yang menghubungi saya langsung jam 2 malam dan kebetulan darah yang dibutuhkan itu golongan darah O sama dengan saya,” ucap Asep sambil mengingat kejadian malam itu yang tidak akan pernah ia lupakan.
  ...
  },
  {
    id: 4,
    image: stories4,
    kategori: 'Cerita Donor darah',
    title: 'BNN RI Semarakkan HUT Korpri ke-52 Lewat Aksi Donor Darah ',
    imgUser: imgUser,
    nameUser: 'Nonem',
    date: "13 Okt 2023",
    description: `Aksi donor darah ini berlokasi di area Klinik Atmani Wedhana, Kantor Pusat BNN RI. Dalam kegiatan ini juga turut serta dari Palang Merah Indonesia (PMI) DKI Jakarta.
    ...
    “Alasan saya ikut donor ini ingin membantu sesama. Caranya juga mudah isi form, lalu dicek kesehatannya terus donor dan dapat bekal (recovery).
  ...
  },
  {
    ...
    Selain pengabdian kepada masyarakat dalam bentuk donor darah, setiap mahasiswa fakultas dan sekolah Tahap Persiapan Bersama (TPB) 2023 juga akan melakukan aksi angkatan yang akan dipamerkan pada In Harmonia Fest November 2023 ini.
  ...
  },
  {
    ...
    image: stories6,
    kategori: 'Cerita Unik',
    title: 'Berikan Pertolongan ke Orang yang Sangat Membutuhkan adalah Hal yang Penting ',
    imgUser: imgUser,
    nameUser: 'Rizandi',
    date: "October 14, 2023",
    description: `Pertolongan kepada utk seorang bayi yg sangat membutuhkan mendesak, menyelamatkan nyawa seorang itu sesuatu yg sangat penting.`
  },

  {
    ...
    nameUser: 'sample',
    imgUser: imgUser,
    description : "kepedulian terhadap kesehatan masyarakat adalah hal yang penting. Mahasiswa senior memberikan dorongan dan pengalaman mereka kepada yang lebih junior, menciptakan ikatan kuat di antara mereka dalam upaya menyelamatkan nyawa.",
    date: "October 14, 2023"
},
{
    id: 8,
    ...
    imgUser: imgUser,
    nameUser: 'sample',
    description: "Maya menjadi pahlawan tanpa tanda bintang. Ketika krisis darah melanda rumah sakit setempat, Maya memimpin inisiatif donor darah sukarela di tempat kerjanya. Dengan dukungan rekan-rekannya, mereka berhasil mengumpulkan cukup darah untuk menyelamatkan nyawa puluhan pasien. ",
    date: "October 9, 2023"
},
{
    id: 9,
    ...
    imgUser: imgUser,
    nameUser: 'sample',
    description: "Mengalami petualangan donor darah yang tak terlupakan. Ketika Anisa membutuhkan transfusi darah mendesak, Rian tanpa ragu menjadi pendonor yang cocok. Proses donor darah bukan hanya menyelamatkan nyawa Anisa, tetapi juga memperkuat ikatan cinta mereka.",
    date: "October 6, 2023"
